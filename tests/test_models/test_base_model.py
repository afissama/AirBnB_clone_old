...
class TestBase(unittest.TestCase):
    ...
    def test_current_date(self):
        ...
        """
        base1 = BaseModel()
        self.assertEqual(base1.created_at.replace(microsecond=0), datetime.now().replace(microsecond=0))
    ...
    def test_update_date(self):
        ...
        """
        base1 = BaseModel()
        self.assertEqual(base1.update_at.replace(microsecond=0), datetime.now().replace(microsecond=0))
